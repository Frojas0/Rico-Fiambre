...
//			ProductoPeso productoPeso23 =(new ProductoPeso("AZUL ESTILO FRANCES",TipoProducto.LACTEO ,"Queso de alta cremosidad que tienen en su pasta cultivos de Penicillium añadidos al producto final y que proporcionan un color entre el azul y el gris-verdoso característico debido a los mohos.",30.0,1300.0,PaisProducto.NACIONAL ,7.5,"https://d3ugyf2ht6aenh.cloudfront.net/stores/001/429/739/products/queso-azul-estilo-frances1-6aeaff98b29d94b88516316352988110-1024-1024.jpg"));
			...
			ProductoUni productoUni19 =(new ProductoUni("PICADA TRADICIONAL PARA 2/3 PERSONAS",TipoProducto.PICADA,"Panes saborizados, salchichón con jamon, aceitunas verdes y queso blanco.",100,9000.0,PaisProducto.NACIONAL ,8.5,"https://res.cloudinary.com/dehmotgth/image/upload/v1685718521/5_kfv7et.png"));
			ProductoUni productoUni20 =(new ProductoUni("PICADA TRADICIONAL PARA 5/6 PERSONAS",TipoProducto.PICADA ,"Panes saborizados, salchichón con jamon, aceitunas verdes y queso blanco.",100,20000.0,PaisProducto.NACIONAL,7,"https://res.cloudinary.com/dehmotgth/image/upload/v1685718518/6_pdjxgg.png"));
			ProductoUni productoUni21 =(new ProductoUni("PICADA CLASICA PARA 2/3 PERSONAS",TipoProducto.PICADA,"Paté de tomate seco, jamón crudo, aceitunas verdes y queso brio.",100,10000.0,PaisProducto.SUDAMERICANO,5,"https://res.cloudinary.com/dehmotgth/image/upload/v1685718518/1_dighxq.png"));
			ProductoUni productoUni22 =(new ProductoUni("PICADA CLASICA PARA 5/6 PERSONAS",TipoProducto.PICADA,"Paté de tomate seco, jamón crudo, aceitunas verdes y queso brio.",100,22000.0,PaisProducto.SUDAMERICANO ,7,"https://res.cloudinary.com/dehmotgth/image/upload/v1685718518/2_jkfrxl.png"));
			ProductoUni productoUni23 =(new ProductoUni("PICADA SELECCION DE FIAMBRES 2/3 PERSONAS",TipoProducto.PICADA ,"Uvas verdes, jamón crudo, queso blanco con ciboulette, aceitunas verdes y negras, salamin y queso roquefort.",50,12000.0,PaisProducto.SUDAMERICANO,10,"https://res.cloudinary.com/dehmotgth/image/upload/v1685718518/4_wxynvf.png"));
			ProductoUni productoUni24 =(new ProductoUni("PICADA SELECCION DE FIAMBRES 5/6 PERSONAS",TipoProducto.PICADA ,"Uvas verdes, jamón crudo, queso blanco con ciboulette, aceitunas verdes y negras, salamin y queso roquefort.",50,24000.0,PaisProducto.SUDAMERICANO ,10,"https://res.cloudinary.com/dehmotgth/image/upload/v1685718518/3_vqncc9.png"));
