...
public class RicoFiambreApplication {
	...
	public CommandLineRunner initData(ClienteRepositorio clienteRepositorio, OrdenRepositorio ordenRepositorio, ProductoPesoRepositorio productoPesoRepositorio, ProductoUniRepositorio productoUniRepositorio, TicketRepositorio ticketRepositorio, OrdenProductoPesoRepositorio ordenProductoPesoRepositorio, OrdenProductoUniRepositorio ordenProductoUniRepositorio) {
		return (args) -> {
			...
			//CREACION DE PRODUCTO POR UNIDAD
			ProductoUni productoUni02 =(new ProductoUni("CERVEZA MILLER LATA 473ml",TipoProducto.BEBIDAALC, "Es una cerveza americana de tipo lager, suave y fácil de beber. De contenido alcohólico moderado y combinado con su punto amargo, hacen que esta cerveza sea una de las mas refrescantes dentro de su segmento", 100, 350.0, PaisProducto.NORTEAMERICANO,  7, "https://ardiaprod.vtexassets.com/arquivos/ids/231206-800-auto?v=638026469267100000&width=800&height=auto&aspect=true"));
			ProductoUni productoUni03 =(new ProductoUni("CERVEZA HEINEKEN LATA 473ml",TipoProducto.BEBIDAALC,"Es una cerveza única, y desde 1873 hasta la fecha conserva la misma calidad, principios e ingredientes. A diferencia de cualquier otra cerveza en México, lo que la hace mas clara, pura y durable. 5% Alc.",100,455.0,PaisProducto.SUDAMERICANO,8,"https://ardiaprod.vtexassets.com/arquivos/ids/231095-800-auto?v=638026467435200000&width=800&height=auto&aspect=true"));
			ProductoUni productoUni04 =(new ProductoUni("CERVEZA QUILMES LATA 354ml",TipoProducto.BEBIDAALC,"Es una cerveza lager argentina, elaborada con ingredientes nacionales. Con equilibrio entre el suave amargor del lúpulo y el sabor del cereal. Color amarillo dorado brillante. Es una cerveza equilibrada, de gran refrescancia y cuerpo balanceado.",120,0.0,PaisProducto.NACIONAL,5,"https://ardiaprod.vtexassets.com/arquivos/ids/184142-800-auto?v=637427537470730000&width=800&height=auto&aspect=true"));
			ProductoUni productoUni05 =(new ProductoUni("CERVEZA ANDES ORIGEN ROJA LATA 473ml",TipoProducto.BEBIDAALC,"Es una cerveza que posee un final seco y una leve acidez que la hacen muy versátil. Es una cerveza de color ámbar cobrizo que tiene estilo Vienna Lager, su aroma a suave caramelo y leve lúpulo logran un balance perfecto.",150,370.0,PaisProducto.NACIONAL ,10,"https://ardiaprod.vtexassets.com/arquivos/ids/196306-800-auto?v=637545920180300000&width=800&height=auto&aspect=true"));
			ProductoUni productoUni06 =(new ProductoUni("CERVEZA CORONA LATA 269ml",TipoProducto.BEBIDAALC ,"Es una cerveza clara y brillante, de espuma blanca y consistente. Destacan sus ligeras notas afrutadas, resultado de la fermentación. De cuerpo medio, fresca, balanceada y muy fácil de beber. En boca es moderadamente dulce y recuerda al sabor del cereal.",100,320.0,PaisProducto.SUDAMERICANO,7,"https://ardiaprod.vtexassets.com/arquivos/ids/231313-800-auto?v=638026471022630000&width=800&height=auto&aspect=true"));
			ProductoUni productoUni07 =(new ProductoUni("CERVEZA ANDES ORIGEN RUBIA LATA 473ml",TipoProducto.BEBIDAALC ,"Es una cerveza estilo american pilsner, una rubia con cuerpo y carácter maltoso. Aroma leve a lúpulo, cereal y toque de levadura. Debe servirse en copa para apreciar mejor sus aromas y resaltar así su color dorado brillante.",100,350.0,PaisProducto.NACIONAL,5,"https://ardiaprod.vtexassets.com/arquivos/ids/247892-800-auto?v=638167491755330000&width=800&height=auto&aspect=true"));
			ProductoUni productoUni08 =(new ProductoUni("CERVEZA BRAHMA LATA 473ml",TipoProducto.BEBIDAALC ,"Es una cerveza bastante plana, casi podríamos decir sosa, con un ligero regusto un poco artificial. A pesar de ello, resulta refrescante, siempre sirviéndola muy fría.",150,300.0,PaisProducto.SUDAMERICANO,5,"https://ardiaprod.vtexassets.com/arquivos/ids/192108-800-auto?v=637506170079900000&width=800&height=auto&aspect=true"));
			ProductoUni productoUni09 =(new ProductoUni("GASEOSA COCA-COLA SIN AZUCAR 1,5Lts",TipoProducto.BEBIDA ," ",200,290.0,PaisProducto.SUDAMERICANO,5,"https://ardiaprod.vtexassets.com/arquivos/ids/247386-800-auto?v=638157866953570000&width=800&height=auto&aspect=true"));
			ProductoUni productoUni10 =(new ProductoUni("GASEOSA SPRITE LIMA-LIMON 2,25Lts",TipoProducto.BEBIDA ," ",200,380.0,PaisProducto.SUDAMERICANO,8.5,"https://ardiaprod.vtexassets.com/arquivos/ids/253441-800-auto?v=638211302931070000&width=800&height=auto&aspect=true"));
			ProductoUni productoUni11 =(new ProductoUni("GASEOSA FANTA NARANJA SIN AZUCAR 1,75Lts",TipoProducto.BEBIDA ," ",150,290.0, PaisProducto.SUDAMERICANO,7,"https://ardiaprod.vtexassets.com/arquivos/ids/245449-800-auto?v=638121507743870000&width=800&height=auto&aspect=true"));
			ProductoUni productoUni12 =(new ProductoUni("GASEOSA COCA-COLA SIN AZUCAR 500ml",TipoProducto.BEBIDA," ",150,240.0,PaisProducto.SUDAMERICANO,5,"https://ardiaprod.vtexassets.com/arquivos/ids/245376-800-auto?v=638121506477330000&width=800&height=auto&aspect=true"));
			ProductoUni productoUni13 =(new ProductoUni("GASEOSA SEVEN UP LIMA LIMON 500ml",TipoProducto.BEBIDA ," ",300,170.0,PaisProducto.SUDAMERICANO ,9,"https://ardiaprod.vtexassets.com/arquivos/ids/245226-800-auto?v=638121504033530000&width=800&height=auto&aspect=true"));
			ProductoUni productoUni14 =(new ProductoUni("GASEOSA LEVITE FIZZ POMELO 575ml",TipoProducto.BEBIDA ," ",400,140.0,PaisProducto.SUDAMERICANO,2,"https://ardiaprod.vtexassets.com/arquivos/ids/249302-800-auto?v=638181574478270000&width=800&height=auto&aspect=true"));
			ProductoUni productoUni15 =(new ProductoUni("PATA DE JAMÓN CRUDO CON JAMONERA",TipoProducto.ENCURTIDO ,"Pata de Jamón crudo seleccionado con 12 meses de estacionamiento con jamonera",10,59000.0,PaisProducto.NACIONAL ,9,"https://d3ugyf2ht6aenh.cloudfront.net/stores/001/429/739/products/jamon-crudo-con-jamonera-021-d074da5124eab70af316305882910895-1024-1024.jpg"));
			ProductoUni productoUni16 =(new ProductoUni("GASEOSA COCA-COLA SABOR ORIGINAL 1,5Lts",TipoProducto.BEBIDA ," ",700,350.0,PaisProducto.SUDAMERICANO ,10,"https://ardiaprod.vtexassets.com/arquivos/ids/253451-800-auto?v=638211303044670000&width=800&height=auto&aspect=true"));
			ProductoUni productoUni17 =(new ProductoUni("GASEOSA COLA PEPSI 500ml",TipoProducto.BEBIDA ," ",180,170.0,PaisProducto.SUDAMERICANO ,10,"https://ardiaprod.vtexassets.com/arquivos/ids/244675-800-auto?v=638120919633630000&width=800&height=auto&aspect=true"));
			ProductoUni productoUni18 =(new ProductoUni("GASEOSA SEVEN UP LIMA LATA 354ml",TipoProducto.BEBIDA ," ",140,150.0,PaisProducto.SUDAMERICANO ,7.5,"https://ardiaprod.vtexassets.com/arquivos/ids/245237-800-auto?v=638121504184370000&width=800&height=auto&aspect=true"));
			ProductoUni productoUni19 =(new ProductoUni("PICADA TRADICIONAL PARA 2/3 PERSONAS",TipoProducto.PICADA,"Panes saborizados, salchichón con jamon, aceitunas verdes y queso blanco.",100,9000.0,PaisProducto.NACIONAL ,8.5,""));
			ProductoUni productoUni20 =(new ProductoUni("PICADA TRADICIONAL PARA 5/6 PERSONAS",TipoProducto.PICADA ,"Panes saborizados, salchichón con jamon, aceitunas verdes y queso blanco.",100,20000.0,PaisProducto.NACIONAL,7,""));
			ProductoUni productoUni21 =(new ProductoUni("PICADA CLASICA PARA 2/3 PERSONAS",TipoProducto.PICADA,"Paté de tomate seco, jamón crudo, aceitunas verdes y queso brio.",100,10000.0,PaisProducto.SUDAMERICANO,5,""));
			ProductoUni productoUni22 =(new ProductoUni("PICADA CLASICA PARA 5/6 PERSONAS",TipoProducto.PICADA,"Paté de tomate seco, jamón crudo, aceitunas verdes y queso brio.",100,22000.0,PaisProducto.SUDAMERICANO ,7,""));
			ProductoUni productoUni23 =(new ProductoUni("PICADA SELECCION DE FIAMBRES 2/3 PERSONAS",TipoProducto.PICADA ,"Uvas verdes, jamón crudo, queso blanco con ciboulette, aceitunas verdes y negras, salamin y queso roquefort.",50,12000.0,PaisProducto.SUDAMERICANO,10,""));
			ProductoUni productoUni24 =(new ProductoUni("PICADA SELECCION DE FIAMBRES 5/6 PERSONAS",TipoProducto.PICADA ,"Uvas verdes, jamón crudo, queso blanco con ciboulette, aceitunas verdes y negras, salamin y queso roquefort.",50,24000.0,PaisProducto.SUDAMERICANO ,10,""));
